document.addEventListener('DOMContentLoaded', function () {
    ...
    async function buscarCliente() {
        ...
        try {
            ...
            const response = await fetch(`https://4e85bfc27ed8.ngrok-free.app/api/cliente-embargos/${cedula}`);
            ...
            if (cliente.foto_perfil) {
                clienteFotoPerfil.src = `https://4e85bfc27ed8.ngrok-free.app${cliente.foto_perfil}`;
    ...
    function actualizarDetalleCliente(cliente) {
        ...
        if (cliente.foto_perfil) {
            fotoPerfil.src = `https://4e85bfc27ed8.ngrok-free.app${cliente.foto_perfil}`;
        } else {
...
async function seleccionarEstadoFinal(estado) {
    ...
    try {
        const response = await fetch('https://4e85bfc27ed8.ngrok-free.app/api/crear-embargos', {
            method: 'POST',
        ...
        if (subsanacionSI) {
            ...
            try {
                ...
                const notifRes = await fetch('https://4e85bfc27ed8.ngrok-free.app/api/notificaciones-embargos', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
