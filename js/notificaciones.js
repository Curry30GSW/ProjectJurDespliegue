...
function eliminarNotificacion(htmlId, idEmbargo) {
    ...
    Swal.fire({
        ...
        fetch(`https://cruel-rules-cheer.loca.lt/api/embargos/${idEmbargo}/notificar`, {
            method: 'PUT',
            headers: {
...
function mostrarTodasLasAlertas() {
    ...
    Promise.all([
        fetch("https://cruel-rules-cheer.loca.lt/api/clientes-embargos").then(res => res.json()),
        fetch("https://cruel-rules-cheer.loca.lt/api/notificaciones-embargo").then(res => res.json())
    ])
