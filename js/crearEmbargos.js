document.addEventListener('DOMContentLoaded', function () {
    ...
    async function buscarCliente() {
        ...
        try {
            ...
            const response = await fetch(`https://cdb43d23d78a.ngrok-free.app/api/cliente-embargos/${cedula}`);
...
async function seleccionarEstadoFinal(estado) {
    ...
    try {
        const response = await fetch('https://cdb43d23d78a.ngrok-free.app/api/crear-embargos', {
            method: 'POST',
        ...
        if (subsanacionSI) {
            ...
            try {
                ...
                const notifRes = await fetch('https://cdb43d23d78a.ngrok-free.app/api/notificaciones-embargos', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
